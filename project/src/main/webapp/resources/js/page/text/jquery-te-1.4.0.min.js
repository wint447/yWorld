			...
			return this.each(
					function(){
						...
						function U(){
							...
							if(e){p.data("linkOpened",true);
							d.show()
							}
							else{p.data("linkOpened",false);
							d.hide()}X()
							}
							function X(e){
								if(e)w.show();
							...
							function V(e){
								...
								function et(e){
									...
									if(e.length>10)e=e.substr(0,7)+"...";t.html(e)
									}
								function tt(e){
								...
								for(var L=0;L<u.fsizes.length;L++){
									p.find("."+u.css+"_fontsizes").append("<a "+u.css+'-styleval="'+u.fsizes[L]+'" class="'+u.css+"_fontsize"+'" role="menuitem" unselectable>'+u.fsizes[L]+'</a>')
									}
								}
											...
											for(var A=0;A<s.length;A++){
												...
												else p.find("."+u.css+"_cpalette").append('<div class="'+u.css+"_colorSeperator"+'"></div>')}}}}w.data("linktype","0");
												for(var T=0;T<3;T++){
													...
													if(t){
														...
														_.unbind("click").click(
															...
															// if(u.placeholder&&u.placeholder!="")
																...
																// 종료하고자 하는 DIV
																// 찾기
																var parent_div = $(this).closest('[class~=draggable][class~=text]');
																...
																// 글이 남겨져 있는경우 에디터만 종료
																	...
																	// 에디터 종료
																	parent_div.find("[id=jqte-div]").jqte({
																		"status" : false
																	});
																	
																	// 종료 되었을 때의 드래그 가능한 DIV 설정
																	draggable_switch('ON',$("[class~=draggable][class~=text]"));
																	editor_switch('OFF',$("[class~=editor][class~=text]"));
																}
															}
															else{
																if(!p.data("sourceOpened")){
																	if(e(this).data("command")=="linkcreator"){
																		...
																		Z(false);
																		X();
																		e(this).data("emphasis")==true&&!e(this).hasClass(m)?e(this).addClass(m):e(this).removeClass(m);x.addClass(u.css+"_hiddenField");
															...
															v.trigger("change")
																...
																if(u.title&&e(this).data("title")!=""&&(e(t.target).hasClass(u.css+"_tool")||e(t.target).hasClass(u.css+"_tool_icon"))){
																	...
																	var o=i.top+e(this).outerHeight()+5;n.delay(400).css({top:o,left:s}).fadeIn(200)}},function(){
																		e("."+u.css+"_title").remove()});
														var ot=null;
																	...
																	if(!p.data("sourceOpened")){
																		...
																		ot=setTimeout(nt,10)
																			...
																			// 에디터가 포커스 되었을 때
																				...
																				console.log("add mouseup keyup");
																				if(e.isFunction(u.focus))
																					u.focus();
																				h.addClass(u.css+"_focused");
																				$(".jqte_focused").draggable();
																				$(".jqte_focused").draggable( "option", "disabled", true );
																				if(/opera/.test(a)){
																				...
																				// 에디터가 포커스를 잃었을 때
																					...
																					console.log("remove mouseup keyup");
																					// 에디터에 드래그 기능 허용
																					$(".jqte_focused").draggable({ 
																						disabled : false
														...
														l.bind("keydown keyup",function(){
															...
															if(e(this).val()=="")e(this).height(0)}).focus(function(){
																h.addClass(u.css+"_focused")}).focusout(function(){
																	h.removeClass(u.css+"_focused")})})}})(jQuery)
